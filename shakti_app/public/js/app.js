...
function updateCart(fresh) {
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/update-cart', fresh).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var fresh = JSON.parse(btn.dataset.fresh);
    updateCart(fresh);
    console.log(fresh);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkshakti"] = self["webpackChunkshakti"] || [];
